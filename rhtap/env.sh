...
export GITOPS_REPO_URL=https://github.com/rhtap-qe-jsmid/twdt7ro4g-python-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.cluster-296x6.296x6.sandbox1641.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.cluster-296x6.296x6.sandbox1641.opentlc.com}
